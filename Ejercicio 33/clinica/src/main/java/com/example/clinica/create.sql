...
create table IF NOT EXISTS paciente(id INT primary key NOT NULL AUTO_INCREMENT,apellido VARCHAR (255), nombre VARCHAR (255), email VARCHAR (255), DNI int, fechaIngreso DATE);
